...
const GOOGLE_API_KEY = "AIzaSyDI6CiAGP3sRwMfs5VUuFKAoyBDOlVrlr0";
...
const loadSavedChatHistory = () => {
    ...
    savedConversations.forEach(conversation => {
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="assets/senteros.png" alt="SenterosAI avatar">
...
const displayLoadingAnimation = () => {
    const loadingHtml = `
        ...
        <div class="message__content">
            <img class="message__avatar" src="assets/senteros.png" alt="SentarosAI avatar">
            <p class="message__text"></p>
